...
public class PersonController {
    ...
    private List<Person> personList = new ArrayList<Person>(); // to store person data

    @Autowired // injecting the service / autoinstantiate the service
    ...
    @RequestMapping(value={"/", "/home", "/index"}, method = RequestMethod.GET) //Request Method is an Enum
    ...
    // demonstration to show the output of the data in json format
